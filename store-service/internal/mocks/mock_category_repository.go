...
// Source: store-service/internal/repository/category_repository.go
//
// Generated by this command:
//
//	mockgen -source=store-service/internal/repository/category_repository.go -destination=store-service/internal/mocks/mock_category_repository.go -package=mocks
//
...
func (m *MockCategoryRepository) FindAll(ctx context.Context) ([]model.Category, error) {
	m.ctrl.T.Helper()
